...
psyche_deps(){
	...
	turn_psyche_16_dt source_xiaomi_psyche
...
psyche_rom_setup(){
	...
	#if [[ ! $(grep 'revision="android-16' .repo/manifests/default.xml) ]];then echo -e "\033[1;33m=>\033[0m SKIP - source code is \033[1;33mnot Android 16\033[0m";exit;fi
