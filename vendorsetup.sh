...
psyche_deps(){
	...
	git_check_dir https://github.com/VoidUI/hardware_xiaomi aosp-12.1 hardware/xiaomi
	...
	git_check_dir https://github.com/stuartore/kernel_xiaomi_sm8250 aosp-13 kernel/xiaomi/void-aosp-sm8250
